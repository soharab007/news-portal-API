                            ...
                            <div class="card-body">
                                ...
                                <div class=" d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h4 class="px-2">${singleMenu.total_view !== null ? singleMenu.total_view : "No data founed here"}</h4>
                                    </div>
                                    <div class="d-flex align-items-center">
    ...
    <div class=" my-3 d-flex align-items-center justify-content-between">
        <div class="d-flex align-items-center">
            <img src="${detail.author.img}"
                class="custom-width-10 img-fluid rounded-circle">
            <div>
                <h5>${detail.author.name !== null ? detail.author.name : "No data found here"}</h5>
        <h6> ${detail.author.published_date !== null ? detail.author.published_date : "No Data"}</h6>
            </div >
        </div >
        <div class="d-flex align-items-center">
            <i class="fa-solid fa-eye"></i>
            <h4 class="px-2">${detail.total_view !== null ? detail.total_view : "No data found here"}</h4>
        </div>
        <div class="d-flex align-items-center">
